# Generated by Django 5.2.6 on 2025-12-14 10:44
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('TRAINEE', 'Trainee'), ('WRITER', 'Writer'), ('ADMIN', 'Admin')], default='TRAINEE', max_length=10)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('type', models.CharField(choices=[('ASSESSMENT', 'Assessment'), ('PAID', 'Paid')], default='ASSESSMENT', max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', models.CharField(choices=[('DEPOSIT', 'Deposit'), ('REFUND', 'Refund'), ('PAYOUT', 'Payout')], max_length=20)),
